  ...
  return (
    <div className="min-h-[70vh] flex items-center justify-center py-10">
      <div className="w-full max-w-sm mx-auto bg-white border border-gray-100 rounded-3xl p-8 shadow-sm">
        ...
        <h1 className="text-xl font-black text-center mb-1">
          {isKo ? "로그인" : "Iniciar sesión"}
        </h1>
        ...
        >
          {loading ? (
            <svg className="animate-spin w-5 h-5 text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" aria-hidden="true">
