    ...
    <footer className="mt-20 border-t border-gray-100 bg-gray-50">
      <div className="max-w-screen-xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-[1fr_auto] gap-10">
          ...
          {/* Nav links */}
          <div>
            <p className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-3">{t("nav")}</p>
            ...
            <div className="mt-5">
              <p className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-2">{t("contact")}</p>
              <a
                href={`mailto:${t("email")}`}
                className="text-sm text-gray-500 hover:text-black transition-colors"
              >
